...
import { AnswerPrompt } from "@/components/music/answer-prompt";
import { CardPrompts } from "@/components/music/card-prompts";
...
async function submitUserMessage(content: string) {
  ...
  async function handleEvent(event: any) {
    ...
    if (eventType === "on_llm_start" || eventType === "on_llm_stream") {
      ...
      if (event.name === "getPrompts" && parsedOutput) {
        toolNode = <CardPrompts prompts={parsedOutput} />;
      } else {
        toolNode = <AnswerPrompt data={parsedOutput} />;
      }
      ui.append(toolNode);
    }
  }
